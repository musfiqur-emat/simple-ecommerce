...
echo "<ul class='pagination'>";
     if($page != 1){
echo "<li><a href='new__arrival.php?page=".($page-1)."' class='button'>Previous</a></li>"; 
     }

for ($i=1; $i<=$total_pages; $i++) {  
    echo "<li><a href='new__arrival.php?page=".$i."'>".$i."</a></li>";
};  

     
if($page != $total_pages){
echo "<li><a href='new__arrival.php?page=".($page+1)."' class='button'>NEXT</a></li>";
     }
echo "</ul>"; 
     ;
};  
